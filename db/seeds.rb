...
50.times do |i|
  Task.create!(title: "third_task", content: "休養する", deadline_on: "2025-02-16", priority: 0, status: 2, user_id: 1)
end

50.times do |i|
  Task.create!(title: "second_task", content: "勉強する", deadline_on: "2025-02-18", priority: 1, status: 0, user_id: 2)
end